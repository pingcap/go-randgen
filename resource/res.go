...
func resourceDefaultZzLua() (*asset, error) {
	...
	info := bindataFileInfo{name: "resource/default.zz.lua", size: 490, mode: os.FileMode(436), modTime: time.Unix(1568111271, 0)}
...
func resourceEnglishTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "resource/english.txt", size: 445, mode: os.FileMode(436), modTime: time.Unix(1571104918, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
